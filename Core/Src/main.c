...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOB, LED_BLUE_Pin | LED_RED_Pin | LED_GREEN_Pin,
                    GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_BLUE_Pin LED_RED_Pin LED_GREE_Pin */
